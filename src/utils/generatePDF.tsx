...
export function generatePDF(formData: any) {
  ...
  doc.setFontSize(10);
  doc.text(`Full Name: ${formData.driverName || "N/A"}`, 10, 50);
  doc.text(`Date of Birth: ${formData.driverDOB || "N/A"}`, 10, 60);
...
// export function generatePDF(formData: Partial<DriverType>) {
//   const driverName = formData.driverName;
//   const driverDOB = formData.driverDOB;
...
//   doc.setFontSize(10);
//   doc.text(`Full Name: ${driverName || "N/A"}`, 10, 50);
//   doc.text(`Date of Birth: ${driverDOB || "N/A"}`, 10, 60);
